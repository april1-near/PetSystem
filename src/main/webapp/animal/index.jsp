...
<section class="footer-w3">
    <div class="container">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 footer-agile1" data-aos="zoom-in">
            <h3>联系方式</h3>
            <p>手机号<span style="font-size: 22px;color: red;margin-left: 5px;">111111111</span></p>
            <br>
            <p>邮箱<span style="font-size: 22px;color: red;margin-left: 5px;">12313545@163.com</span></p>
            <br>
            <p>官网<span style="font-size: 22px;color: red;margin-left: 5px;">wrerere</span></p>
            <br>
